...
class registraSegundaPesadaCompraTrailerAutomatica(QDialog):
    def __init__(self, ticket, parent=None):
        super(registraSegundaPesadaCompraTrailerAutomatica, self).__init__(parent, flags=Qt.WindowCloseButtonHint)
        loadUi('Operador_Segunda_Compra_Trailer_Automatica.ui', self)
        logger.debug("Operador_Segunda_Compra_Trailer_Automatica")
        logger.debug("Operador registra segunda pesada Automatica Trailer")
        self.DB_Connect()

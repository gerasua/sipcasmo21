...
class registraSegundaPesadaDevClienteTrailerAutomatica(QDialog):
    def __init__(self, ticket, parent=None):
        super(registraSegundaPesadaDevClienteTrailerAutomatica, self).__init__(parent, flags=Qt.WindowCloseButtonHint)
        loadUi('Operador_Segunda_DevCliente_Trailer_Automatica.ui', self)
        logger.debug("Operador_Segunda_DevCliente_Trailer_Automatica")
        logger.debug("Operador registra segunda pesada Devolución de Cliente Automatica Trailer")
        self.DB_Connect()
    ...
    def onDataChanged(self, KG):
        ...
        logger.debug("Kilos en el LCD: {}".format(self.lcdNumber_7.value()))

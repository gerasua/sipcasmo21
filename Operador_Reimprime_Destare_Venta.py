...
class reimprimirVentaDestare(QDialog):
    def __init__(self, ticketres, parent=None):
        super(reimprimirVentaDestare, self).__init__(parent, flags=Qt.WindowCloseButtonHint)
        loadUi('Operador_Reimprime_Destare_Venta.ui', self)
        logger.debug("Operador_Reimprime_Destare_Venta")
        logger.debug("Operador re imprime ticket de Venta Destare")
        self.DB_Connect()
    ...
    def insertarDatos4(self):
        ...
        #         printer.text("Destino: {}".format(self.destino))
        #         try:
        #             printer.text(f"Observaciones: {self.observaciones_salida}")
        #             # printer.text("Observaciones: {}".format(self.observaciones_salida))
        #         except Exception as e:

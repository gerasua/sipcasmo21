...
class operadorCreateDestinovtaSolas(QDialog):
    def __init__(self, parent=None):
        super(operadorCreateDestinovtaSolas, self).__init__(parent, flags=Qt.WindowCloseButtonHint)
        loadUi('Operador_Destinovta_Create.ui', self)
        logger.debug("Ventana agregar Destino venta SOLAS")
        self.DB_Connect()
    ...
    def agregar(self):
        ...
        if self.nombre:
            ...
            try:
                query = "INSERT INTO `totalco_destino_vta_solas` (`id_destino_vta_solas`, `destino_vta_solas`) VALUES (NULL, '{}')".format(
                    self.nombre)
                args = (self.nombre)

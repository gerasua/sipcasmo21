...
class operadorUpdateDestinovtaSolas(QDialog):
    def __init__(self, idItem, nombreItem, parent=None):
        super(operadorUpdateDestinovtaSolas, self).__init__(parent, flags=Qt.WindowCloseButtonHint)
        loadUi('Operador_DestinovtaSolas_Update.ui', self)
    ...
    def actualizar(self):
        ...
        if self.itemUpdate:
            ...
            try:
                query = """ UPDATE totalco_destino_vta_solas SET destino_vta_solas = %s WHERE id_destino_vta_solas = %s """

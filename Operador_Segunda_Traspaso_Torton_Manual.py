...
class registraSegundaPesadaTraspasoTortonManual(QDialog):
    def __init__(self, ticket, parent=None):
        super(registraSegundaPesadaTraspasoTortonManual, self).__init__(parent, flags=Qt.WindowCloseButtonHint)
        loadUi('Operador_Segunda_Traspaso_Torton_Manual.ui', self)
        logger.debug("Operador_Segunda_Traspaso_Torton_Manual")
        logger.debug("Operador registra segunda pesada Traspaso Manual Torton")
        self.DB_Connect()

...
class registraSegundaPesadaCompraTrailerManual(QDialog):
    def __init__(self, ticket, parent=None):
        super(registraSegundaPesadaCompraTrailerManual, self).__init__(parent, flags=Qt.WindowCloseButtonHint)
        loadUi('Operador_Segunda_Compra_Trailer_Manual.ui', self)
        logger.debug("Operador_Segunda_Compra_Trailer_Manual")
        logger.debug("Operador registra segunda pesada Manual Trailer")
        self.DB_Connect()

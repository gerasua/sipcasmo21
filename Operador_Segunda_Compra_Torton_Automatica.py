...
class registraSegundaPesadaCompraTortonAutomatica(QDialog):
    def __init__(self, ticket, parent=None):
        super(registraSegundaPesadaCompraTortonAutomatica, self).__init__(parent, flags=Qt.WindowCloseButtonHint)
        loadUi('Operador_Segunda_Compra_Torton_Automatica.ui', self)
        logger.debug("Operador_Segunda_Compra_Torton_Automatica")
        logger.debug("Operador registra segunda pesada Automatica Torton")
        self.DB_Connect()

...
class registraSegundaPesadaTraspasoTortonAutomatica(QDialog):
    def __init__(self, ticket, parent=None):
        super(registraSegundaPesadaTraspasoTortonAutomatica, self).__init__(parent, flags=Qt.WindowCloseButtonHint)
        loadUi('Operador_Segunda_Traspaso_Torton_Automatica.ui', self)
        logger.debug("Operador_Segunda_Traspaso_Torton_Automatica")
        logger.debug("Operador registra segunda pesada Traspaso Automatica Torton")
        self.DB_Connect()

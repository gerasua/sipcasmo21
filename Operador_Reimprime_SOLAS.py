...
class reimprimirVentaSolas(QDialog):
    def __init__(self, ticketrep, parent=None):
        super(reimprimirVentaSolas, self).__init__(parent, flags=Qt.WindowCloseButtonHint)
        loadUi('Operador_Reimprime_SOLAS.ui', self)
        logger.debug("Operador_Reimprime_SOLAS")
        logger.debug("Operador re imprime ticket de Venta SOLAS")
        self.DB_Connect()
        ...
        self.Linea.setText(str(self.linea))

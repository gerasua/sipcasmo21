...
class registraPrimeraTraspasoTortonAutomatica(QDialog):
    def __init__(self, fn=None, parent=None):
        super(registraPrimeraTraspasoTortonAutomatica, self).__init__(parent, flags=Qt.WindowCloseButtonHint)
        loadUi('Operador_Primera_Traspaso_Torton_Automatica.ui', self)
        logger.debug("Operador_Primera_Traspaso_Torton_Automatica")
        logger.debug("Operador registra primera entrada Traspaso Torton")
        self.DB_Connect()
    ...
    def insertarDatos(self):
        ...
        try:
            query = "INSERT INTO `totalco_boleto_ent` (`id_producto`, `id_sucursal`, `fecha_e`, `hora_e`, `id_tractor`, `id_operador`, `peso_e`, `tipo_pesada`, `id_usuario`, " \
                    "`completo`, `solas`, `observaciones`, `identifica_pedido_tipo`, `ruta_windows`, `ruta_linux`, `captura_cam1`, `captura_cam2`, `captura_cam3`, `ticket_sucursal`, `folio`, `captura_cam4`) " \
                    "VALUES ('{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}')" \
                    "".format(id_producto, id_sucursal, fecha_e, hora_e, id_tractor, id_operador, peso_insertar, self.tipo_pesada, self.id_usuario, completo, solas, observaciones,
                              identifica_pedido_tipo, new_dir_w, dir_linux, imageName1, imageName2, imageName3, ticket_sucursal, folio, imageName4)

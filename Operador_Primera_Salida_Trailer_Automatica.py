...
class registraPrimeraSalidaTrailerAutomatica(QDialog):
    def __init__(self, fn=None, parent=None):
        super(registraPrimeraSalidaTrailerAutomatica, self).__init__(parent, flags=Qt.WindowCloseButtonHint)
        loadUi('Operador_Primera_Salida_Trailer_Automatica.ui', self)
        logger.debug("Operador_Primera_Salida_Trailer_Automatica")
        logger.debug("Operador registra primera Salida")
        self.DB_Connect()

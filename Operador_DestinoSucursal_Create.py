...
class operadorCreateSucursal(QDialog):
    def __init__(self, parent=None):
        super(operadorCreateSucursal, self).__init__(parent, flags=Qt.WindowCloseButtonHint)
        loadUi('Operador_DestinoSucursal_Create.ui', self)
        logger.debug("Ventana agregar Sucursal")
        self.DB_Connect()
    ...
    def agregar(self):
        ...
        if self.nombre:
            ...
            try:
                query = "INSERT INTO `totalco_destino_sucursal` (`id_destino_sucursal`, `destino_sucursal`) VALUES (NULL, '{}')".format(
                    self.nombre)
                args = (self.nombre)

...
class registraSegundaPesadaCompraTortonManual(QDialog):
    def __init__(self, ticket, parent=None):
        super(registraSegundaPesadaCompraTortonManual, self).__init__(parent, flags=Qt.WindowCloseButtonHint)
        loadUi('Operador_Segunda_Compra_Torton_Manual.ui', self)
        logger.debug("Operador_Segunda_Compra_Torton_Manual")
        logger.debug("Operador registra segunda pesada Manual Torton")
        self.DB_Connect()
        self.btnr.clicked.connect(self.regresar)
        self.btn_guardar.clicked.connect(self.ObtenDatos)
        logger.debug("Inicia Segunda Pesada Manual")
    ...
    def insertarDatos(self):
        ...
        try:
            query = "INSERT INTO totalco_boleto_sal(id_bol_sal, id_bol_entra, fecha_s, hora_s, peso_bruto, peso_tara, peso_neto, tipo_pesada, identifica_pedido_tipo, " \
                    "solas, completo, observaciones, destino, ruta_windows, ruta_linux, captura_cam1, captura_cam2, captura_cam3, id_usuario, observaciones_manual, id_operador, id_maniobra, captura_cam4, id_destino) " \
                    "VALUES ('{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}')"\
                .format(self.NumeroTicket, self.NumeroTicket, fecha_s, hora_s, int(self.pesoentrada), int(PesoTara), int(PesoNeto), self.tipo_pesada,
                identifica_pedido_tipo, solas, completo, observaciones, destino, new_dir_w, dir_linux, imageName1, imageName2, imageName3, self.id_usuario, observaciones_manual, id_operador, id_maniobra, imageName4, id_destino)

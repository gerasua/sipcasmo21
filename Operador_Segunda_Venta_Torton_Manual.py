...
class registraSegundaPesadaVentaTortonManual(QDialog):
    def __init__(self, ticket, parent=None):
        super(registraSegundaPesadaVentaTortonManual, self).__init__(parent, flags=Qt.WindowCloseButtonHint)
        loadUi('Operador_Segunda_Venta_Torton_Manual.ui', self)
        logger.debug("Operador_Segunda_Venta_Torton_Manual")
        logger.debug("Operador registra segunda pesada Venta Manual Torton")
        self.DB_Connect()

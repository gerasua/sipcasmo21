...
class reimprimirCompra(QDialog):
    def __init__(self, ticketrep, parent=None):
        super(reimprimirCompra, self).__init__(parent, flags=Qt.WindowCloseButtonHint)
        loadUi('Operador_Reimprime_Compra.ui', self)
        logger.debug("Operador_Reimprime_Compra")
        logger.debug("Operador re imprime ticket de Compra")
        self.DB_Connect()

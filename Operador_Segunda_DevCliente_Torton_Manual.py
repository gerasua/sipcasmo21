...
class registraSegundaPesadaDevClienteTortonManual(QDialog):
    def __init__(self, ticket, parent=None):
        super(registraSegundaPesadaDevClienteTortonManual, self).__init__(parent, flags=Qt.WindowCloseButtonHint)
        loadUi('Operador_Segunda_DevCliente_Torton_Manual.ui', self)
        logger.debug("Operador_Segunda_DevCliente_Torton_Manual")
        logger.debug("Operador registra segunda pesada Devolución de Cliente Manual Torton")
        self.DB_Connect()

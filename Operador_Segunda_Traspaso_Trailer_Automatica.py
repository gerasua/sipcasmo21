...
class registraSegundaPesadaTraspasoTrailerAutomatica(QDialog):
    def __init__(self, ticket, parent=None):
        super(registraSegundaPesadaTraspasoTrailerAutomatica, self).__init__(parent, flags=Qt.WindowCloseButtonHint)
        loadUi('Operador_Segunda_Traspaso_Trailer_Automatica.ui', self)
        logger.debug("Operador_Segunda_Traspaso_Trailer_Automatica")
        logger.debug("Operador registra segunda pesada Traspaso Automatica Trailer")
        self.DB_Connect()

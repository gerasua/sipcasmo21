...
class reimprimirDevCli(QDialog):
    def __init__(self, ticketrep, parent=None):
        super(reimprimirDevCli, self).__init__(parent, flags=Qt.WindowCloseButtonHint)
        loadUi('Operador_Reimprime_DevCli.ui', self)
        logger.debug("Operador_Reimprime_DevCli")
        logger.debug("Operador re imprime ticket de Devolución de Cliente")
        self.DB_Connect()

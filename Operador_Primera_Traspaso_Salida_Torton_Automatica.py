...
class registraPrimeraTraspasoSalidaTortonAutomatica(QDialog):
    def __init__(self, fn=None, parent=None):
        super(registraPrimeraTraspasoSalidaTortonAutomatica, self).__init__(parent, flags=Qt.WindowCloseButtonHint)
        loadUi('Operador_Primera_Traspaso_Salida_Torton_Automatica.ui', self)
        logger.debug("Operador_Primera_Traspaso_Salida_Torton_Automatica")
        logger.debug("Operador registra primera salida Traspaso Torton")
        self.DB_Connect()

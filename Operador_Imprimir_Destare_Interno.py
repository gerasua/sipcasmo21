...
class imprimirDestareInterno(QDialog):
    def __init__(self, destarar_ticket,destarar_primeraPesada,destarar_segundaPesada,destarar_pesoNeto,pyute,ppropileno, praspa, psaco, psaco10, ptarima, pchep, ptreforzada, psacoesp, ptarimaesp, parent=None):
        super(imprimirDestareInterno, self).__init__(parent, flags=Qt.WindowCloseButtonHint)
        loadUi('Operador_Imprimir_Destare_Interno.ui', self)
        logger.debug("Operador_Imprimir_Destare_Interno")
        logger.debug("Operador registra Destare de Movimiento Interno")
        self.DB_Connect()
    ...
    def insertarDatos(self):
        ...
        self.id_identifica_pedido_tipo = 3
        self.identifica_pedido_tipo = "MOVIMIENTO INTERNO"
        ...
        logger.debug("Observaciones: {}".format(self.observaciones_destare))
        ...
        try:
            query = "INSERT INTO totalco_destare(numero_ticket, id_origen, origen, id_producto, producto, " \
                    ...
                    ", '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}'" \
                    ", '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}'," \
                    "'{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}')".format(self.NumeroTicket, self.id_origen, self.origen,

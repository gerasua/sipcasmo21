...
class registraSegundaPesadaDevClienteTrailerManual(QDialog):
    def __init__(self, ticket, parent=None):
        super(registraSegundaPesadaDevClienteTrailerManual, self).__init__(parent, flags=Qt.WindowCloseButtonHint)
        loadUi('Operador_Segunda_DevCliente_Trailer_Manual.ui', self)
        logger.debug("Operador_Segunda_DevCliente_Trailer_Manual")
        logger.debug("Operador registra segunda pesada Devolución de Cliente Manual Trailer")
        self.DB_Connect()

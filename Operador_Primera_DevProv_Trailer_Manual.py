...
class registraPrimeraDevProvTrailerManual(QDialog):
    def __init__(self, fn=None, parent=None):
        super(registraPrimeraDevProvTrailerManual, self).__init__(parent, flags=Qt.WindowCloseButtonHint)
        loadUi('Operador_Primera_DevProv_Trailer_Manual.ui', self)
        logger.debug("Operador_Primera_DevProv_Trailer_Manual")
        logger.debug("Operador registra primera pesada Dev. a Proveedor Trailer Manual")
        self.DB_Connect()
    ...
    def insertarDatos(self):
        ...
        try:
            query = "INSERT INTO `totalco_boleto_ent` (`id_producto`, `id_proveedor`, `fecha_e`, `hora_e`, `id_tractor`, `id_operador`, `peso_e`, `tipo_pesada`, `id_usuario`, " \
                    "`completo`, `solas`, `observaciones`, `identifica_pedido_tipo`, `ruta_windows`, `ruta_linux`, `captura_cam1`, `captura_cam2`, `captura_cam3`, `carta_porte`, `folio`, `id_portacontenedor`, `lote`, `observaciones_manual`, `captura_cam4`) " \
                    "VALUES ('{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}')" \
                    "".format(id_producto, id_proveedor, fecha_e, hora_e, id_tractor, id_operador, peso_insertar, self.tipo_pesada, self.id_usuario, completo, solas, observaciones,
                              identifica_pedido_tipo, new_dir_w, dir_linux, imageName1, imageName2, imageName3, cartaPorte, folio, id_placas_caja, lote, observaciones_manual, imageName4)

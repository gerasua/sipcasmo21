...
class registraSegundaPesadaTraspasoTrailerManual(QDialog):
    def __init__(self, ticket, parent=None):
        super(registraSegundaPesadaTraspasoTrailerManual, self).__init__(parent, flags=Qt.WindowCloseButtonHint)
        loadUi('Operador_Segunda_Traspaso_Trailer_Manual.ui', self)
        logger.debug("Operador_Segunda_Traspaso_Trailer_Manual")
        logger.debug("Operador registra segunda pesada Traspaso Manual Trailer")
        self.DB_Connect()

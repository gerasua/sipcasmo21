...
class operadorUpdateDestinovta(QDialog):
    def __init__(self, idItem, nombreItem, parent=None):
        super(operadorUpdateDestinovta, self).__init__(parent, flags=Qt.WindowCloseButtonHint)
        loadUi('Operador_Destinovta_Update.ui', self)
    ...
    def actualizar(self):
        ...
        if self.itemUpdate:
            ...
            try:
                query = """ UPDATE totalco_destino_vta SET destino_vta = %s WHERE id_destino_vta = %s """

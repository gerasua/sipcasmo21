...
class reimprimirDevProvDestare(QDialog):
    def __init__(self, ticketres, parent=None):
        super(reimprimirDevProvDestare, self).__init__(parent, flags=Qt.WindowCloseButtonHint)
        loadUi('Operador_Reimprime_Destare_DevProv.ui', self)
        logger.debug("Operador_Reimprime_Destare_DevProv")
        logger.debug("Operador re imprime ticket de Devolución a Proveedor Destare")
        self.DB_Connect()
    ...
    def insertarDatos3(self):
        ...
        if self.impresora == "Impresora de Cinta":
            ...
            try:
                ...
                printer.text(" ")
                printer.text("Operador: {}".format(self.usario_destara))
                printer.text(" ")
    ...
    def insertarDatos4(self):
        ...
        #         printer.text("Observaciones: {}".format(str(self.observaciones_salida)))
        #         printer.text("================================")
        #
        #     except Exception as e:
        #         logger.exception("Error con la impresora de tickets: {}".format(e))

...
class registraSegundaPesadaDevProvTortonManual(QDialog):
    def __init__(self, ticket, parent=None):
        super(registraSegundaPesadaDevProvTortonManual, self).__init__(parent, flags=Qt.WindowCloseButtonHint)
        loadUi('Operador_Segunda_DevProv_Torton_Manual.ui', self)
        logger.debug("Operador_Segunda_DevProv_Torton_Manual")
        logger.debug("Operador registra segunda pesada Dev. a Proveedor Manual Torton")
        self.DB_Connect()

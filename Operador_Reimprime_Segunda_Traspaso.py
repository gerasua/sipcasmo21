...
class reimprimirTraspasoSegunda(QDialog):
    def __init__(self, ticketres, parent=None):
        super(reimprimirTraspasoSegunda, self).__init__(parent, flags=Qt.WindowCloseButtonHint)
        loadUi('Operador_Reimprime_Segunda_Traspaso.ui', self)
        logger.debug("Operador_Reimprime_Segunda_Traspaso")
        logger.debug("Operador re imprime ticket de Traspaso de sucursal 2a Pesada")
        self.DB_Connect()
    ...
    def insertarDatos2(self):
        ...
        if self.impresora == "Impresora de Cinta":
            ...
            try:
                ...
                printer.text("Chofer: {}".format(self.SFechaHora))
    ...
    def insertarDatos3(self):
        ...
        #             printer.text("Fecha/Hora: {}".format(self.SFechaHora))
        #         except Exception as e:
        #             logger.debug(f"Errror en variable Fecha/Hora {e}")
        #         printer.text(f" ")

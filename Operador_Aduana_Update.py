...
class operadorUpdateAduana(QDialog):
    def __init__(self, idItem, nombreItem, parent=None):
        super(operadorUpdateAduana, self).__init__(parent, flags=Qt.WindowCloseButtonHint)
        loadUi('Operador_Aduana_Update.ui', self)
    ...
    def actualizar(self):
        ...
        if self.itemUpdate:
            ...
            try:
                query = """ UPDATE totalco_agencia_aduanal SET nombre = %s WHERE id_aduana = %s """

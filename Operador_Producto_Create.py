...
class operadorCreateProducto(QDialog):
    def __init__(self, parent=None):
        super(operadorCreateProducto, self).__init__(parent, flags=Qt.WindowCloseButtonHint)
        loadUi('Operador_Producto_Create.ui', self)
        logger.debug("Ventana agregar Producto")
        self.DB_Connect()
    ...
    def agregar(self):
        ...
        if self.nombre:
            ...
            try:
                query = "INSERT INTO `totalco_producto` (`id_producto`, `clave_producto`, `nombre_producto`, `clave_sap`) VALUES (NULL, '{}', '{}', '{}')".format(

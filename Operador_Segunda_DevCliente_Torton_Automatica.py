...
class registraSegundaPesadaDevClienteTortonAutomatica(QDialog):
    def __init__(self, ticket, parent=None):
        super(registraSegundaPesadaDevClienteTortonAutomatica, self).__init__(parent, flags=Qt.WindowCloseButtonHint)
        loadUi('Operador_Segunda_DevCliente_Torton_Automatica.ui', self)
        logger.debug("Operador_Segunda_DevCliente_Torton_Automatica")
        logger.debug("Operador registra segunda pesada Devolución de Cliente Automatica Torton")
        self.DB_Connect()

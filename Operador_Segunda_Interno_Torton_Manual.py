...
class registraSegundaPesadaInternoTortonManual(QDialog):
    def __init__(self, ticket, parent=None):
        super(registraSegundaPesadaInternoTortonManual, self).__init__(parent, flags=Qt.WindowCloseButtonHint)
        loadUi('Operador_Segunda_Interno_Torton_Manual.ui', self)
        logger.debug("Operador_Segunda_Interno_Torton_Manual")
        logger.debug("Operador registra segunda pesada Interno Manual Torton")
        self.DB_Connect()
        ...
        try:
            ...
            self.origen = self.row[38]
        except Exception as e:
            logger.debug("Error: {}".format(e))

        self.lcdNumber_3.display(self.pesoentrada)
        # self.Line_origen.setText(str(self.origen))
    ...
    def insertarDatos(self):
        ...
        try:
            query = "INSERT INTO totalco_boleto_sal(id_bol_sal, id_bol_entra, fecha_s, hora_s, peso_bruto, peso_tara, peso_neto, tipo_pesada, identifica_pedido_tipo, " \
                    "solas, completo, observaciones, destino, ruta_windows, ruta_linux, captura_cam1, captura_cam2, captura_cam3, id_usuario, id_operador, id_maniobra, observaciones_manual, captura_cam4, id_destino) " \
                    "VALUES ('{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}')"\
                .format(self.NumeroTicket, self.NumeroTicket, fecha_s, hora_s, self.pesoentrada, PesoTara, PesoNeto, self.tipo_pesada,
                identifica_pedido_tipo, solas, completo, observaciones, destino, new_dir_w, dir_linux, imageName1, imageName2, imageName3, self.id_usuario, id_operador, id_maniobra, observaciones_manual, imageName4, id_destino)

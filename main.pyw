...
class Window2(QMainWindow):
    def __init__(self):
        ...
        try:
            ...
            self.ui.btn_salida.clicked.connect(self.primera_menu_tracto_salida)
            self.ui.btn_back_1p_menu_salida_tracto.clicked.connect(self.primera_menu)
            ...
            # BOTONES PRIMERA PESADA ==> TRASPASO
                ...
                try:
                    ...
                    for resultado in self.resultados:
                        if resultado[8] == None:
                            ...
                            def pedido4():
                                self.tipoPedido = str("Traspaso de Sucursal")
                            def pedido5():
                            ...
                            if int(tipo_torcajporta) == 2:
                                ...
                                try:
                                    ...
                                    if int(self.tipo_pesada) != 0:
                                        logger.debug("El valor lo ingresa el usuario")
                                        try:
                                            logger.debug("TRASPASO DE SUCURSAL Segunda Pesada Manual de Torton")
                                        ...
                                        logger.debug("El valor es ingresado a través del indicador")
                                        try:
                                            logger.debug("TRASPASO DE SUCURSAL Segunda Pesada Automatica de un Torton")
                                ...
                                try:
                                    ...
                                    if int(self.tipo_pesada) != 0:
                                        logger.debug("El valor lo ingresa el usuario")
                                        try:
                                            logger.debug("TRASPASO DE SUCURSAL Segunda Pesada Manual de un trailer")
                                        ...
                                        logger.debug("El valor es ingresado a través del indicador")
                                        try:
                                            logger.debug("TRASPASO DE SUCURSAL Segunda Pesada Automatica de un trailer")

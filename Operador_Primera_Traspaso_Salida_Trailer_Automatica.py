...
class registraPrimeraTraspasoSalidaTrailerAutomatica(QDialog):
    def __init__(self, fn=None, parent=None):
        super(registraPrimeraTraspasoSalidaTrailerAutomatica, self).__init__(parent, flags=Qt.WindowCloseButtonHint)
        loadUi('Operador_Primera_Traspaso_Salida_Trailer_Automatica.ui', self)
        logger.debug("Operador_Primera_Traspaso_Salida_Trailer_Automatica")
        logger.debug("Operador registra primera Salida Traspaso Trailer Automatica")
        self.DB_Connect()
        ...
        try:
            query = "INSERT INTO `totalco_boleto_ent` (`id_producto`, `id_sucursal`, `fecha_e`, `hora_e`, `id_tractor`, `id_operador`, `peso_e`, `tipo_pesada`, `id_usuario`, " \
                    ...
                    "".format(id_producto, id_sucursal, fecha_e, hora_e, id_tractor, id_operador, peso_insertar, self.tipo_pesada, self.id_usuario, completo, solas, observaciones,
                              identifica_pedido_tipo, new_dir_w, dir_linux, imageName1, imageName2, imageName3, id_placas_caja, imageName4)

...
class operadorUpdateTipoCont(QDialog):
    def __init__(self, idItem, nombreItem, parent=None):
        super(operadorUpdateTipoCont, self).__init__(parent, flags=Qt.WindowCloseButtonHint)
        loadUi('Operador_TipoCont_Update.ui', self)
    ...
    def actualizar(self):
        ...
        if self.itemUpdate:
            ...
            try:
                query = """ UPDATE totalco_contenedor_tipo SET contenedor_tipo = %s WHERE id_contenedor_tipo = %s """

...
class registraPrimeraCompraTortonAutomatica(QDialog):
    def __init__(self, fn=None, parent=None):
        super(registraPrimeraCompraTortonAutomatica, self).__init__(parent, flags=Qt.WindowCloseButtonHint)
        loadUi('Operador_Primera_Compra_Torton_Automatica.ui', self)
        logger.debug("Operador_Primera_Compra_Torton_Automatica")
        logger.debug("Operador registra primera entrada Automatica")
        self.DB_Connect()
    ...
    def onDataChanged(self, KG):
        logger.debug("Kilos en el onDataChanged: %s" % KG)
    ...
    def insertarDatos(self):
        ...
        peso_insertar = int(self.lcdNumber_7.value())
        logger.debug("Peso a insertar en variable: {}".format(peso_insertar))
        ...
        ##
        # Si la pesada NO es sencilla se pesa normal
        ##
        if pesada_sencilla == 'NO':
            ...
            try:
                query = "INSERT INTO `totalco_boleto_ent` (`id_producto`, `id_proveedor`, `id_proveedor_origen`, `fecha_e`, `hora_e`, `id_tractor`, `id_operador`, `peso_e`, `tipo_pesada`, `id_usuario`, " \
                        ...
                        "VALUES ('{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}')" \
                        "".format(id_producto, id_proveedor, id_proveedor_origen, fecha_e, hora_e, id_tractor, id_operador, peso_insertar, self.tipo_pesada, self.id_usuario, completo, solas, observaciones,
                                  identifica_pedido_tipo, new_dir_w, dir_linux, imageName1, imageName2, imageName3, cartaPorte, folio, imageName4)
        ...
        ##
            ...
            try:
                ...
                query = "INSERT INTO totalco_boleto_sal(id_bol_sal, id_bol_entra, fecha_s, hora_s, peso_bruto, peso_tara, peso_neto, tipo_pesada, identifica_pedido_tipo, " \
                        ...
                        "VALUES ('{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}')" \
                    .format(numboleto, numboleto, fecha_e, hora_e, peso_insertar, insertar_peso_tara, peso_insertar,
                            self.tipo_pesada,
                            identifica_pedido_tipo, solas, completo_destare, observaciones_empty, destino, new_dir_w, dir_linux,
                            imageName1, imageName2, imageName3, self.id_usuario, id_operador, id_maniobra, imageName4,
                            id_destino)
                logger.debug("Query: {}".format(query))
                self.cur.execute(query)
                self.conn.commit()
            ...
            if self.impresora == "Impresora de Cinta":
                ...
                try:
                    ...
                    printer.text("Peso Neto: {}".format(peso_insertar))
                    printer.text("Fecha/Hora: {}".format(fechahora))
                    printer.text("Producto: {}".format(producto))
                    printer.text("Chofer: {}".format(operador))
                    printer.text("Pesador: {}".format(self.pesador))

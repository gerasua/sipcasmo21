...
class registraSegundaPesadaVentaTrailerManual(QDialog):
    def __init__(self, ticket, parent=None):
        super(registraSegundaPesadaVentaTrailerManual, self).__init__(parent, flags=Qt.WindowCloseButtonHint)
        loadUi('Operador_Segunda_Venta_Trailer_Manual.ui', self)
        logger.debug("Operador_Segunda_Venta_Trailer_Manual")
        logger.debug("Operador registra segunda pesada Venta Manual Trailer")
        self.DB_Connect()
    ...
    def insertarDatos(self):
        ...
        try:
            query = "INSERT INTO totalco_boleto_sal(id_bol_sal, id_bol_entra, fecha_s, hora_s, peso_bruto, peso_tara, peso_neto, tipo_pesada, identifica_pedido_tipo, " \
                    "solas, completo, observaciones, id_destino_vta, ruta_windows, ruta_linux, captura_cam1, captura_cam2, captura_cam3, id_usuario, id_operador, id_maniobra, observaciones_manual, captura_cam4) " \
                    "VALUES ('{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}')"\
                .format(self.NumeroTicket, self.NumeroTicket, fecha_s, hora_s, self.pesoentrada, PesoTara, PesoNeto, self.tipo_pesada,
                identifica_pedido_tipo, solas, completo, observaciones, destino, new_dir_w, dir_linux, imageName1, imageName2, imageName3, self.id_usuario, id_operador, id_maniobra, observaciones_manual, imageName4)

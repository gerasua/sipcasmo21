...
class operadorUpdateTipoTracto(QDialog):
    def __init__(self, idItem, nombreItem, parent=None):
        super(operadorUpdateTipoTracto, self).__init__(parent, flags=Qt.WindowCloseButtonHint)
        loadUi('Operador_TipoTracto_Update.ui', self)
    ...
    def actualizar(self):
        ...
        if self.itemUpdate:
            ...
            try:
                query = """ UPDATE totalco_tipo_tracto SET tipo_tracto = %s WHERE id_tipo_tracto = %s """

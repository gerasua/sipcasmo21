...
class operadorUpdateTransportista(QDialog):
    def __init__(self, idItem, nombreItem, parent=None):
        super(operadorUpdateTransportista, self).__init__(parent, flags=Qt.WindowCloseButtonHint)
        loadUi('Operador_Transportista_Update.ui', self)
    ...
    def actualizar(self):
        ...
        if self.itemUpdate:
            ...
            try:
                query = """ UPDATE totalco_transporte SET linea = %s WHERE id_transporte = %s """

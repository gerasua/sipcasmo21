...
class operadorCreateDestinoSifon(QDialog):
    def __init__(self, parent=None):
        super(operadorCreateDestinoSifon, self).__init__(parent, flags=Qt.WindowCloseButtonHint)
        loadUi('Operador_DestinoSifon_Create.ui', self)
        logger.debug("Ventana agregar sifon/maquila/bodega")
        self.DB_Connect()
    ...
    def agregar(self):
        ...
        if self.nombre:
            ...
            try:
                query = "INSERT INTO `totalco_destino` (`id_destino`, `destino`) VALUES (NULL, '{}')".format(
                    self.nombre)
                args = (self.nombre)

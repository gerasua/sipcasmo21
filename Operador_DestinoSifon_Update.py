...
class operadorUpdateSifon(QDialog):
    def __init__(self, idItem, nombreItem, parent=None):
        super(operadorUpdateSifon, self).__init__(parent, flags=Qt.WindowCloseButtonHint)
        loadUi('Operador_DestinoSifon_Update.ui', self)
    ...
    def actualizar(self):
        ...
        if self.itemUpdate:
            ...
            try:
                query = """ UPDATE totalco_destino SET destino = %s WHERE id_destino = %s """

...
class registraSegundaPesadaDevProvTortonAutomatica(QDialog):
    def __init__(self, ticket, parent=None):
        super(registraSegundaPesadaDevProvTortonAutomatica, self).__init__(parent, flags=Qt.WindowCloseButtonHint)
        loadUi('Operador_Segunda_DevProv_Torton_Automatica.ui', self)
        logger.debug("Operador_Segunda_DevProv_Torton_Automatica")
        logger.debug("Operador registra segunda pesada Dev. a Proveedor Automatica Torton")
        self.DB_Connect()

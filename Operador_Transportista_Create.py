...
class operadorCreateTransportista(QDialog):
    def __init__(self, parent=None):
        super(operadorCreateTransportista, self).__init__(parent, flags=Qt.WindowCloseButtonHint)
        loadUi('Operador_Transportista_Create.ui', self)
        logger.debug("Ventana agregar Transportista")
        self.DB_Connect()
    ...
    def agregar(self):
        ...
        if self.nombre:
            ...
            try:
                query = "INSERT INTO `totalco_transporte` (`id_transporte`, `linea`) VALUES (NULL, '{}')".format(
                    self.nombre)
                args = (self.nombre)

...
class registraPrimeraTraspasoSalidaTortonManual(QDialog):
    def __init__(self, fn=None, parent=None):
        super(registraPrimeraTraspasoSalidaTortonManual, self).__init__(parent, flags=Qt.WindowCloseButtonHint)
        loadUi('Operador_Primera_Traspaso_Salida_Torton_Manual.ui', self)
        logger.debug("Operador_Primera_Traspaso_Salida_Torton_Manual")
        logger.debug("Operador registra primera Salida Traspaso Torton Manual")
        self.DB_Connect()
